...
> Construye e integra herramientas personalizadas para extender la funcionalidad del SDK de Claude Code
...
<Note>
  **Importante:** Las herramientas MCP personalizadas requieren modo de entrada de streaming. Debes usar un generador/iterable asíncrono para el parámetro `prompt` - una cadena simple no funcionará con servidores MCP.
</Note>
...
<CodeGroup>
  ...
  const apiGatewayServer = createSdkMcpServer({
    ...
    tools: [
      tool(
        "api_request",
        "Hacer solicitudes de API autenticadas a servicios externos",
        {
...
* [Referencia del SDK de TypeScript](/es/docs/claude-code/sdk/typescript)
* [Referencia del SDK de Python](/es/docs/claude-code/sdk/python)
* [Documentación de MCP](https://modelcontextprotocol.io)
* [Configuración del SDK](/es/docs/claude-code/sdk/sdk-configuration)
